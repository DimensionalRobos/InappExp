...
public class WordNetDemo {
    ...
    public static void main(String[] args) throws JWNLException {
        ...
        WordNetHelper.initialize("C:\\Users\\user\\Documents\\GitHub\\InappExp\\app\\InappExp-Java\\file_properties.xml");
        ...
        start = WordNetHelper.getWord(POS.NOUN, "screw");
        end = WordNetHelper.getWord(POS.NOUN, "toy");
